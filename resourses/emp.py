...
class Emp(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            if len(x)>0: return {"message":"an employee with that employno already exists"},400
        except:
        ...
        if data['comm']!=None:
            try:
                ...
                return {"message":"There was a problem inserting to emp table."},500

            return {"message":"successfully inserted."},201
        else:
            try:
                query(f"""INSERT INTO testapi.emp (empno,ename,job,mgr,hiredate,sal,deptno,pass) VALUES({data['empno']},
                                                     '{data['ename']}',
                                                     '{data['job']}',
                                                      {data['mgr']},
                                                      '{data['hiredate']}',
                ...
                return {"message":"There was a problem connecting to emp table."},500
